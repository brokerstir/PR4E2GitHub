...
# Actual data: http://python-data.dr-chuck.net/comments_174672.xml (Sum ends with 95)
...
url = 'http://python-data.dr-chuck.net/comments_174672.xml' #raw_input('Enter - ')
data = urllib.urlopen(url).read()
tree = ET.fromstring(data)
print 'Retrieved',len(data),'characters'
counts = tree.findall('.//count')
print 'Number of Comment Counts:',len(counts)
sum = 0
for count in counts:
    number = count.text
    number = int(number)
    sum += number
print 'Sum of Comment Counts:',sum
