...
# Please run your program to find the place_id for "Smolensk State University" and enter the place_id and your Python code below. Hint: The first seven characters of the place_id are "ChIJO1f ..."
import urllib
import json
